...
CREATE TABLE `cancellation` (
  ...
  `titleCancel` varchar(100) NOT NULL,
  `reasonCancel` text NOT NULL,
  `idFlight` int NOT NULL,
  PRIMARY KEY (`idCancellation`),
  UNIQUE KEY `idCancellation_UNIQUE` (`idCancellation`),
  KEY `fk_idFlight_cancellation_idx` (`idFlight`),
  CONSTRAINT `fk_idFlight_cancellation` FOREIGN KEY (`idFlight`) REFERENCES `flight` (`idFlight`)
...
-- Dump completed on 2021-10-14 20:58:51
