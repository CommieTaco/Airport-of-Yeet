...
CREATE TABLE `airline` (
  ...
  `countryRegistration` varchar(100) NOT NULL,
  PRIMARY KEY (`idAirline`),
  UNIQUE KEY `idAirline_UNIQUE` (`idAirline`)
...
INSERT INTO `airline` VALUES (1,'Japan Airways','Japan'),(2,'Qantas','Australia'),(3,'Taca','El Salvador');
